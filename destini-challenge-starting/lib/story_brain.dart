...
class StoryBrain {
  ...
  List<Story> _storyData = [
    ...
    Story(
        ...
        choice1: 'Restart',
        choice2: '',
        storyNumChoice1: null,
        storyNumChoice2: null),
    Story(
        storyTitle:
  ...
  void nextStory(int userChoice) {
    if (_storyNumber < 3) {
      if (userChoice == 1) {
        _storyNumber = _storyData[_storyNumber].storyNumChoice1;
      } else if (userChoice == 2) {
        _storyNumber = _storyData[_storyNumber].storyNumChoice2;
      }
    } else {
      restart();
    }
  ...
  bool buttonShouldBeVisible() => _storyNumber < 3 && _storyNumber >= 0;
}
